  ...
  if (loading)
    return (
      <div className={styles.loadingWrap}>
        ...
        <span>Cargando datos del cultivo...</span>
      </div>
    );
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <BtnBack href={`/cultivos/${id}`} label="Volver al detalle" />
        <h1 className={styles.pageTitle}>Editar campo de cultivo</h1>
